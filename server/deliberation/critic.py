...
Instructions:
Before revising, categorize each of your findings into exactly one of these buckets:
  CONFIRMED   — evidence directly supports the finding
  CHALLENGED  — the critique raised a valid concern about this finding
  UNCERTAIN   — insufficient data to decide either way
  NEW         — finding emerged from the critique itself

Address CHALLENGED items first. Include the category label in raw_revision.
