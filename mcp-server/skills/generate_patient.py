    ...
    try:
        ...
        async with pool.acquire() as conn:
            ...
            await conn.execute(
                ...
                insurance_type, is_synthetic, datetime.utcnow(), data_track,
            )
            ...
            for cond in conditions:
                await conn.execute(
                    ...
                    cond.get("clinical_status", "active"), data_track,
                )
                cond_count += 1
            ...
            for med in medications:
                await conn.execute(
                    ...
                    med.get("authored_on"), data_track,
                )
                med_count += 1
            ...
            await conn.execute(
                ...
                """,
                str(uuid.uuid4()), patient_id, data_track, True,
                datetime.utcnow(), data_track,
            )
